...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { carrier: @phone.carrier, name: @phone.name, price: @phone.price, term: @phone.term }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { carrier: @phone.carrier, name: @phone.name, price: @phone.price, term: @phone.term }
    assert_redirected_to phone_path(assigns(:phone))
  end
